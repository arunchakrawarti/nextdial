...
//         <div className="flex items-center gap-2 flex-1 min-w-0 overflow-hidden text-sm font-medium text-gray-600 dark:text-gray-300">
...
//           <button
//             onClick={toggleTheme}
//             className="flex h-9 w-9 sm:h-9 sm:w-9 items-center border border-gray-500 justify-center rounded-lg text-gray-700 
...
//             )}
//           </button>
//           <div className="hidden lg:flex items-center gap-2 text-gray-500 dark:text-gray-300 font-semibold">
