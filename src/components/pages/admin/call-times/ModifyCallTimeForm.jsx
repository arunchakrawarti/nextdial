  ...
  return (
    <div className="w-full bg-white border border-light rounded-2xl overflow-hidden mt-5">
      <div className="px-4 sm:px-6 py-5 border-b border-light">
        <h2 className="heading font-lexend">Modify a Call Time</h2>
      </div>
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <Input label="Default Start" type="text" defaultValue="1200" />
          <Input label="Default Stop" type="text" defaultValue="1700" />
          <Input label="AH Override" type="text" placeholder="audio chooser" />
          <Input label="Sunday Start" type="text" defaultValue="0" />
          <Input label="Sunday Stop" type="text" defaultValue="0" />
          <Input label="AH Override" type="text" placeholder="audio chooser" />
        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 xl:grid-cols-[280px_1fr_auto] gap-6 items-end">
            ...
            <Input
              ...
              options={[
                {
                  label: "alabama - Alabama 8am-8pm and Sunday",
                  value: "alabama",
                },
                {
                  label: "california - California 9am-9pm",
                  value: "california",
                },
              ]}
            />
      ...
      <div className="bg-white border-t border-light px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        <div className="space-y-8 text-center">
          <div>
            <h3 className="text-[18px] sm:text-[20px] font-bold uppercase text-dark">
              Campaign Using This Call Time:
            </h3>
            <div className="flex flex-wrap justify-center gap-4 mt-4">
              <span className="text-primary cursor-pointer hover:underline">
                testcamp
              </span>
              <span className="text-dark">testcamp</span>
            </div>
          </div>
        ...
        <div className="mt-10 flex flex-col items-start gap-4">
          <p
            ...
            className="text-primary hover:underline text-[16px] sm:text-[18px] font-semibold uppercase text-left transition-all font-lexend cursor-pointer"
          >
            DELETE THIS CALL TIME DEFINITION
          </p>

          {showDeleteConfirm && (
            <div className="w-full border border-light rounded-xl bg-white p-4 sm:p-5 space-y-3">
