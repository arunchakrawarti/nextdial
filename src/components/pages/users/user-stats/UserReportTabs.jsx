  ...
  const navItems = [
    {
      ...
      icon: <Clock size={18} className="text-[#5a52cd]" />,
    },
    {
      id: 2,
      label: "User Status",
      path: "/users/user-status",
      icon: <User size={18} className="text-[#5a52cd]" />,
    },
    {
      id: 3,
      label: "Modify User",
      path: "/users/time-sheet",
      icon: <LayoutGrid size={18} className="text-[#5a52cd]" />,
    },
    {
      id: 4,
      label: "User multiple day status detail report",
      path: "/users/time-sheet",
      icon: <Calendar size={18} className="text-[#5a52cd]" />,
    },
  ];
