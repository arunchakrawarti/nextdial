  ...
  return (
    <div className="w-full  space-y-6">
      <div className="flex items-center gap-3">
        <h1 className="heading font-lexend">Modify a Users Record</h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-6 border border-light space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Input label="User Number" type="text" placeholder="1002" />

            <Input label="User Level" type="select" options={["1", "2", "3"]} />

            <div className="md:col-span-2">
              <Input label="Password" type="text" placeholder="1002" />
            </div>
            ...
            <div>
              ...
              <div className="w-full h-11 px-3 bg-[#f8f9fa] border border-[#e2e8f0] rounded-md flex flex-col justify-center text-[11px] text-gray-400 font-medium">
                ...
                <span className="text-[#5a52cd] cursor-pointer hover:underline">
                  Logins summary
                </span>
              </div>
            </div>

            <Input label="Full Name" type="text" placeholder="1002" />
            ...
            <Input label="Phone Login" type="text" placeholder="5001" />

            <Input label="Phone Pass" type="text" placeholder="5001" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-light space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative">
              <Input label="Voicemail ID" type="text" />
            </div>
            ...
            <Input label="User Code" type="text" />
            ...
            <Input label="Main Territory" type="text" />

            <div className="md:col-span-2">
              <Input label="User Nickname" type="text" />
            </div>
          </div>
        </div>
      </div>
