    ...
    <form className="w-full  space-y-6">
      <div className="w-full bg-white rounded-xl border-light overflow-hidden">
        <div className="bg-primary px-6 py-4 flex items-center gap-2">
          ...
          <h2 className="heading font-lexend">Admin Options</h2>
        </div>

        <div className="p-6 space-y-8">
          <div className="space-y-4">
            <div className="bg-primary px-4 py-2 rounded-md">
              <h3 className="heading font-lexend">Admin Report Options</h3>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-primary px-4 py-2 rounded-md">
              <h3 className="heading font-lexend">Admin Interface Options</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              />
              <Input
                label="Alter Agent Interface Options"
                type="select"
                options={["0", "1"]}
                defaultValue="1"
              />
              ...
              />
              <Input
                label="GDPR-Compliant Export Delete Leads"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              ...
              />
              <Input
                label="Modify Campaign Dial Prefix"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              ...
              />
              <Input
                label="Modify In-Groups"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Delete In-Groups"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              ...
              />
              <Input
                label="Modify Custom Dialplans"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Modify Remote Agents"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Delete Remote Agents"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Modify Scripts"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              ...
              />
              <Input
                label="AGC Admin Access"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="AGC Delete Phones"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Modify Call Times"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Delete Call Times"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Modify Servers"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              ...
              />
              <Input
                label="Modify Statuses"
                type="select"
                options={["0", "1"]}
                defaultValue="1"
              />
              <Input
                label="Modify Voicemail"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Modify Audio Store"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Modify Music On Hold"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              ...
              />
              <Input
                label="CallCard Access"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Add Timeclock Log Record"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Modify Timeclock Log Record"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Delete Timeclock Log Record"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Manager Shift Enforcement Override"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Manager Pause Code Approval"
                type="select"
                options={["0", "1"]}
                defaultValue="1"
              />
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-400 italic pl-1">
              No config inputs required for this subsection.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Input
                label="Modify Same User Level"
                type="select"
                options={["0", "1"]}
                defaultValue="1"
              />
              <Input
                label="Download Invalid Files"
                type="select"
                options={["0", "1"]}
                defaultValue="0"
              />
              <Input
                label="Alter Admin Interface Options"
                type="select"
                options={["0", "1"]}
                defaultValue="1"
              />
